...
export default function Sudoku({ sudoku }: SudokuProps): JSX.Element {
    const [state, dispatch] = React.useReducer(
        reducer,
        computeInitialState(sudoku)
    );
    const [areControlsDisplayed, setAreControlsDisplayed] = React.useState(
        true
    );
        ...
        <div className={styles.container}>
            <div className={styles.buttons}>
                <button
                    ...
                    onClick={() =>
                        setAreControlsDisplayed(!areControlsDisplayed)
                    }
                >
                    <svg
